...
import capitulo11.SomarNumeroNegativosException;

public interface Soma {

    /**
     * Este é metado static para soma  de dois valores inteiros
     * @param valor1
     * @param valor2
     * @return
     * para adicionar java doc tem que adiciona /** bem encima do metodo
     */
